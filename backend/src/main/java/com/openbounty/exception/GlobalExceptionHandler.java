...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNoResourceFound(NoResourceFoundException ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.NOT_FOUND, "Endpoint Not Found", "The requested path does not exist", request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleInsufficientReward(InsufficientBountyRewardException ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.BAD_REQUEST, "Insufficient Bounty Reward", ex.getMessage(), request);
    }

    @ExceptionHandler(InsufficientBalanceException.class)
    public ResponseEntity<ErrorResponse> handleInsufficientBalance(InsufficientBalanceException ex, HttpServletRequest request) {
        log.warn("Insufficient balance: {}", ex.getMessage());
        return buildResponse(HttpStatus.BAD_REQUEST, "Insufficient Balance", ex.getMessage(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleSelfBidding(SelfBiddingNotAllowedException ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.BAD_REQUEST, "Self-Dealing Forbidden", ex.getMessage(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleMilestoneOrderViolation(MilestoneOrderViolationException ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.BAD_REQUEST, "Milestone Order Violation", ex.getMessage(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleInvalidReview(InvalidReviewException ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.BAD_REQUEST, "Invalid Review", ex.getMessage(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleValidationExceptions(MethodArgumentNotValidException ex, HttpServletRequest request) {
        ...
        return buildResponseWithErrors(HttpStatus.BAD_REQUEST, "Validation Failed", "One or more fields failed validation", request, errors);
    }

    @ExceptionHandler(HttpMessageNotReadableException.class)
    public ResponseEntity<ErrorResponse> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpServletRequest request) {
        log.warn("Malformed HTTP message: {}", ex.getMessage());
        return buildResponse(HttpStatus.BAD_REQUEST, "Malformed JSON Request", "The request body is unreadable or contains invalid enum values", request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleTypeMismatch(MethodArgumentTypeMismatchException ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.BAD_REQUEST, "Invalid Parameter Type", detail, request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleAccountSuspended(AccountSuspendedException ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.FORBIDDEN, "Account Suspended", ex.getMessage(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleDuplicateResource(DuplicateResourceException ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.CONFLICT, "Resource Conflict", ex.getMessage(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(DataIntegrityViolationException ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.CONFLICT, "Database Constraint Violation", "Operation could not be completed due to a database integrity constraint", request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleBountyExpired(BountyExpiredException ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.GONE, "Bounty Expired", ex.getMessage(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handlePaymentProcessing(PaymentProcessingException ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.PAYMENT_REQUIRED, "Payment Processing Failed", ex.getMessage(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleMethodNotSupported(HttpRequestMethodNotSupportedException ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.METHOD_NOT_ALLOWED, "Method Not Allowed", detail, request);
    }
    ...
    private ResponseEntity<ErrorResponse> buildResponse(HttpStatus status, String title, String detail, HttpServletRequest request) {
        return buildResponseWithErrors(status, title, detail, request, null);
    }

    private ResponseEntity<ErrorResponse> buildResponseWithErrors(
            HttpStatus status, String title, String detail, HttpServletRequest request, Map<String, String> errors) {
